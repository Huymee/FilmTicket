...
import com.yuqs.filmticket.Entity.FilmPlayingBean.PlayingFilm;
...
public class PlayingFilmAdapter extends PagerAdapter {
    private List<PlayingFilm> list;
    ...
    public PlayingFilmAdapter(Context context, boolean isMultiScr) {
    ...
    public void addData(List<PlayingFilm> list) {
    ...
    private View initView(CardView view, int position) {
        ViewHolder holder;
        if (view == null) {
            view = (CardView) inflater.inflate(R.layout.item_film_playing_card_view, null);
        ...
        if (list != null && position < list.size()) {
            final PlayingFilm film = list.get(position);
            //获取分数，以便后期使用
            ...
            holder.ivPicture.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra(IURL.ACTION_FILM_TYPE,IURL.FILM_TYPE_PLAYING);
