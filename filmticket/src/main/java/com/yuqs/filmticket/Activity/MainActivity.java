...
public class MainActivity extends AppCompatActivity implements OnFragmentInteractionListener {
    ...
    private void checkPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                requestPermissions(new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 100);//这里的100是一个执行代码
            } else
                return;//获取权限后执行自己的方法
    ...
    OnCheckedChangeListener tabListener = new OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            ...
            MainFragment01.setCurrentPage(checkedIndex);
        }
    };
    ...
    OnCheckedChangeListener bottomListener = new OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            ...
            TextView tvTitle = (TextView) View.inflate(MainActivity.this, R.layout.abar_title, null);
            if (aBar != null) {
            ...
            switch (checkedId) {
                case R.id.rb_film_bottom_a:
                    ...
                    if (frg01 == null) ft.add(R.id.rl_main, new MainFragment01(), "frg1");
    ...
    public void onFragmentInteraction(int position) {
        ((RadioButton) tabGroup.getChildAt(position)).setChecked(true);
    }
}